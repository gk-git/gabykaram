    ...
    >
      ...
      <section>
        <div className="projects">
          ...
          <div className="project">
            <a href="https://mmfidawla.com" target="_blank">
          ...
          <div className="project">
            <a href="https://codebravetutors.org" target="_blank">
          ...
          <div className="project">
            <a href="https://garderlecap.global" target="_blank">
          ...
          <div className="project">
            <a href="https://summerofinnovation.io" target="_blank">
          ...
          <div className="project">
            <a href="https://nextgenlondon.com" target="_blank">
